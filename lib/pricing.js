...
// El descuento por 2+ unidades del tapete aplica en embudo Y tienda (31-ago-2026).
export const PRODUCTOS = {
  tapete: { nombre: 'Tapete Vital', precio: PRECIO_UNITARIO },
  pad: { nombre: 'Pad Portátil', precio: 199000 },
  parches: { nombre: 'Parches Esenciales', precio: 219000 },
};
...
export function calcularTotalCarrito(items, zona) {
  ...
  for (const [key, qty] of Object.entries(items || {})) {
    ...
    detalle[key] = q;
    unidades += q;
    subtotal += precioProducto(key, q) * q;
  }
...
export const ENVIOS = {
  bogota: { 1: 13000, 2: 26000, 3: 26000, 4: 26000, 5: 26000 },
  resto: { 1: 21000, 2: 39000, 3: 46000, 4: 46000, 5: 46000 },
};
...
// Precio unitario de un producto según su cantidad: solo el tapete tiene descuento por volumen.
export function precioProducto(key, cantidad) {
  return key === 'tapete' ? precioUnitario(cantidad) : PRODUCTOS[key].precio;
}
