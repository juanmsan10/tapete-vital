...
export const PRECIO_LISTA = 449000; // precio tachado (ancla)
export const PRECIO_UNITARIO = 299000; // 1 tapete
export const PRECIO_UNITARIO_DESCUENTO = 269000; // 2+ tapetes (10% dcto)
export const CANTIDAD_MAXIMA = 5;

// Envío según cantidad y destino (COP)
export const ENVIOS = {
